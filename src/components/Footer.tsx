    ...
    <footer className="bg-background border-t border-card-border">
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          {/* Social */}
          <div>
            <h4 className="text-white font-semibold text-sm uppercase tracking-widest mb-4">Follow Us</h4>
            <div className="flex flex-col gap-4">
              ...
              >
                <span
                  className="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0 transition-opacity group-hover:opacity-80"
              ...
              {/* Facebook */}
              <a
                href="https://www.facebook.com/bimmerworks.ro/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 group"
              >
              ...
              {/* TikTok */}
              <a
                href="https://www.tiktok.com/@bimmerworks.ro"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 group"
              >
